...
def build_favorites(data, thumbs_map, desc_map, genre_map, epg_window, fav_ids=None):
	...
	for count, item in enumerate(data['channels']):
		...
		#if idx % 2 == 0:
			#li.setProperty("rowbg", "special://home/addons/metalchris.lgchannels.epg/resources/media/row_light.png")
			#parity = "EVEN"
		#else:
			#li.setProperty("rowbg", "special://home/addons/metalchris.lgchannels.epg/resources/media/row_dark.png")
			#parity = "ODD"
