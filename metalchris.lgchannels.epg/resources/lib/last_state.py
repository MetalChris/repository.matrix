...
#FAV_FILE = "special://userdata/addon_data/metalchris.shared/refresh.json"
...
def remove_favorite(chan_id):
    ...
    # --- Confirmation dialog ---
    dlg = xbmcgui.Dialog()
    confirm = dlg.yesno("LG Channels EPG", f"Are you sure you wish to remove {chan_name} from Favorites?")
    if not confirm:
