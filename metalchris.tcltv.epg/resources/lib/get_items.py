...
selfAddon = xbmcaddon.Addon(id='metalchris.tcltv.epg')
translation = selfAddon.getLocalizedString
addon = xbmcaddon.Addon()
addonname = addon.getAddonInfo('name')
settings = xbmcaddon.Addon(id="metalchris.tcltv.epg")
...
defaultimage = 'special://home/addons/metalchris.tcltv.epg/resources/media/icon.png'
