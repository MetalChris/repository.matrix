...
import urllib.request, urllib.parse, urllib.error, urllib.request, urllib.error, urllib.parse, xbmcplugin, xbmcaddon, xbmcgui, re, sys
...
defaultimage = 'special://home/addons/plugin.video.hunt-channel/resources/icon.png'
defaultfanart = 'special://home/addons/plugin.video.hunt-channel/resources/fanart.jpg'
defaulticon = 'special://home/addons/plugin.video.hunt-channel/resources/icon.png'
iconimage = 'special://home/addons/plugin.video.hunt-channel/resources/icon.png'
...
def get_live(name,baseurl,iconimage):
	...
	mediaUrl = urllib.parse.unquote_plus(str(items).split('mediaUrl=')[-1]).split('&amp;')[0]
	xbmc.log('mediaUrl: ' + str(mediaUrl),level=log_level)
	for url in items:
		if not 'zype' in url:
			m3u8 = 'plugin://plugin.video.hunt-channel?mode=99&url=' + urllib.parse.quote_plus(mediaUrl)
...
def addDir(name, url, mode, iconimage, fanart=False, infoLabels=True):
	u = sys.argv[0] + "?url=" + urllib.parse.quote_plus(url) + "&mode=" + str(mode) + "&name=" + urllib.parse.quote_plus(name)# + "&iconimage=" + urllib.quote_plus(iconimage)
	ok = True
